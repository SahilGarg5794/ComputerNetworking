...
public static void main(String[] args)  {
    FtpClient1 client1=new FtpClient1();
    client1.run();
}
...
public void authenticateClient(ObjectOutputStream clientSocketPrintWriter, ObjectInputStream clientSocketReader,
...
public void handleClientInputs(ObjectOutputStream clientSocketPrintWriter, ObjectInputStream clientSocketReader,
                                        BufferedReader inputReader) throws IOException, ClassNotFoundException {
    while (true) {
...
public boolean validateCommand(ObjectInputStream clientSocketReader) throws IOException, ClassNotFoundException {
...
public boolean isFileAvailableOnMachine(String command, ObjectOutputStream clientSocketPrintWriter) throws IOException {
